...
class PrimalDualCalculator:
    ...
    # СМОТРИ СЮДА
    # Фи это то, что в https://arxiv.org/pdf/2012.04516.pdf в (9) без последнего слагаемого
    # h_oracle.func(t) это как раз ненужное слагаемое, а phi_big_oracle.func(t) нужное
