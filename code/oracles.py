...
# СМОТРИ СЮДА
# phi_big_oracle в dual_func_value
# есть и func(t) и grad(t). Вот только проблема в том, что нам нужно func(t, lambda, mu) и grad по lambda и mu.
# А у них lambda и mu как будто вшиты в матрицу корреспонденций и пересчитываются всякими автоматическими оракулами.
# Я что-то не могу понять как вычленить нужное значение фи не меняя их непростую систему оракулов.
